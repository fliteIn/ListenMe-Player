...
class PlaybackExtendedHelpBlock extends StatelessWidget {
  const PlaybackExtendedHelpBlock({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Сам PlaybackExtended (растянутый)
        IgnorePointer(
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 0),
            child: PlaybackExtended(app: app),
          ),
        ),
        const SizedBox(height: 8),

        // Кружочки строго под иконками
        SizedBox(
          height: 32,
          child: Row(
        ...
        Padding(
          ...
          child: buildShadowedText(
            context,
            loc.helpPlaybackExtendedDescription,
